...
toggle = st.toggle('Turn on teh switch', value=True)
if toggle:
...
# img = Image.open('https://search.naver.com/search.naver?ssc=tab.image.all&where=image&sm=tab_jum&query=%EC%B6%95%EA%B5%AC#imgId=image_sas%3Ablog_b5e6ed0363ff33890a60f60ca4e6471a')
